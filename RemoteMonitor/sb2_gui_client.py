...
left_pwm_graph = sb2_gui_widgets.Bargraph(bg, (bg.width/2 - frame.size/2 - 100, bg.height/2 - frame.size/2), (-1,1))
right_pwm_graph = sb2_gui_widgets.Bargraph(bg, (bg.width/2 + frame.size/2 + 50, bg.height/2 - frame.size/2), (-1,1))
left_torque_graph = sb2_gui_widgets.Bargraph(bg, (bg.width/2 - frame.size/2 - 200, bg.height/2 - frame.size/2), (-20,20), (50, 250), (0,0,200))
right_torque_graph = sb2_gui_widgets.Bargraph(bg, (bg.width/2 + frame.size/2 + 150, bg.height/2 - frame.size/2), (-20,20), (50, 250), (0,0,200))
lateral_acc_graph = sb2_gui_widgets.Bargraph(bg, (bg.width/2 - 125, bg.height/2 + frame.size/2 + 50), (-2,2), (250, 50), (128,0,0))
